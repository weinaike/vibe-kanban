...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        utils::api::projects::LinkToExistingRequest::decl(),
        utils::api::projects::CreateRemoteProjectRequest::decl(),
        ...
        utils::api::shared_tasks::SharedTask::decl(),
        utils::api::shared_tasks::ShareTaskResponse::decl(),
        utils::api::shared_tasks::SharedTaskResponse::decl(),
        utils::api::shared_tasks::SharedTaskDetails::decl(),
        ...
        server::routes::oauth::HandoffInitRequest::decl(),
        server::routes::oauth::HandoffInitResponse::decl(),
        server::routes::oauth::HandoffCallbackParams::decl(),
        server::routes::oauth::AuthStatusResponse::decl(),
        ...
        server::routes::tunnels::DeviceListQuery::decl(),
