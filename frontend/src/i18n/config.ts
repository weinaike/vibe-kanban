...
import jaTunnels from './locales/ja/tunnels.json';
import esCommon from './locales/es/common.json';
import esSettings from './locales/es/settings.json';
import esProjects from './locales/es/projects.json';
import esTasks from './locales/es/tasks.json';
import esTunnels from './locales/es/tunnels.json';
import koCommon from './locales/ko/common.json';
import koSettings from './locales/ko/settings.json';
import koProjects from './locales/ko/projects.json';
import koTasks from './locales/ko/tasks.json';
import koTunnels from './locales/ko/tunnels.json';
...
import zhHansTunnels from './locales/zh-Hans/tunnels.json';
...
import zhHantTunnels from './locales/zh-Hant/tunnels.json';
...
i18n
  ...
  .init({
    ...
    defaultNS: 'common',
    ns: ['common', 'settings', 'projects', 'tasks', 'tunnels'],
    ...
    load: 'languageOnly', // Load language only (e.g., zh -> zh-Hans via fallback)
